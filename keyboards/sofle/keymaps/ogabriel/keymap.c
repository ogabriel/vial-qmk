 ...
 *            `----------------------------------'           '------''---------------------------'
 */
  [_QWERTY] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_DEL, KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_ENT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_MUTE, KC_MPLY, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LGUI, KC_BSPC, KC_ENT, KC_SPC, KC_LALT, KC_LALT, KC_SPC, MO(1), MO(2), KC_RGUI),
 ...
 *            `----------------------------------'           '------''---------------------------'
 */
[_LOWER] = LAYOUT(KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_NO, KC_NO, KC_NO, KC_BSLS, KC_SLSH, KC_PIPE, KC_LPRN, KC_RPRN, KC_UNDS, KC_MINS, KC_NO, KC_F12, KC_NO, CEDILLA, KC_GRV, KC_CIRC, KC_QUOT, KC_TILD, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_EQL, KC_PLUS, KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_LCBR, KC_RCBR, KC_QUOT, KC_DQUO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO),
 ...
 *            `----------------------------------'           '------''---------------------------'
 */
[_RAISE] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MSTP, KC_MPLY, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
...
static void print_status_narrow(void) {
    // Print current mode
    oled_write_P(PSTR("\n\n"), false);
    oled_write_ln_P(PSTR("gabs"), false);
...
//         switch (keycode) {
//             case QK_MACRO_0:
//                 SEND_STRING(SS_DOWN(X_KC_LALT)SS_DOWN(X_KC_C)SS_UP(X_KC_LALT));
//                 return false;
//         }
//     }
//
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    if (record->event.pressed) {
        switch (keycode) {
            case CEDILLA:
                SEND_STRING(SS_DOWN(X_RALT)SS_TAP(X_COMMA)SS_UP(X_RALT));
                return false;
        }
    }
